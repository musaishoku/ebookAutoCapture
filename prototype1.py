...
class ebookToPDF:
    ...
    def __init__(self, root):
        ...
        ttk.Progressbar(contents, orient=HORIZONTAL,length=30, mode='determinate', maximum = 10000, variable=self.progress).grid(column=1, row=6, columnspan=3, sticky=(W,E))
